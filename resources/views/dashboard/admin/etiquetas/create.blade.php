        ...
        <div class="card-body px-2 py-4 md:p-5 gap-6">
            <div class="flex flex-col md:flex-row gap-4 justify-between">
                <div class="badge badge-primary self-center md:self-start py-5 w-full md:w-auto">
                    <x-icon name="list-bullet" class="mr-2" solid mini /><span class="text-base font-semibold">Crear etiqueta
                        Etiqueta</span>
                </div>
                <a class="btn btn-outline btn-primary md:btn-sm md:h-full py-0" href="{{ route('admin.etiquetas.index') }}">
            ...
            <div class="overflow-x-auto w-full">
                <div>
                    <div class="flex flex-col gap-6">
                        <form method="POST" action="{{ route('admin.etiquetas.store') }}" accept-charset="UTF-8">
                            @csrf

                            <div class="form-control mb-3">
                                <x-float-input type="text" id="descripcion" name="descripcion" label="Nombre del etiqueta"
