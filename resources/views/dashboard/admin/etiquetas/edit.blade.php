        ...
        <div class="card-body px-2 py-4 md:p-5 gap-6">
            <div class="flex flex-col md:flex-row gap-4 justify-between">
                <div class="badge badge-primary self-center md:self-start py-5 w-full md:w-auto">
                    <x-icon name="list-bullet" class="mr-2" solid mini /><span class="text-base font-semibold">Editar
                        Etiqueta</span>
                </div>
            ...
            <div class="overflow-x-auto w-full">
                <div>
                    <div class="flex flex-col gap-6">
                        <form method="POST" action="{{ route('admin.etiquetas.update', $data) }}" accept-charset="UTF-8">
                            {{ method_field('PUT') }}
                            @csrf
